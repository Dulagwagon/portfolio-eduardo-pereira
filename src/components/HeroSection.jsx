    ...
    <section className="min-h-screen flex items-center justify-center bg-gray-900 
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="
          ...
          font-extrabold leading-tight mb-4 sm:mb-2 
          bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-indigo-200
        ">
          De Ideias a Deploy. Full Stack Developer.
        </h1>
        
        {/* Subtítulo (O Gancho para os Projetos) */}
        <h2 className="text-xl sm:text-3xl text-gray-400 font-light mb-12 sm:mb-8">
          Explore meus projetos em <span className="text-white font-semibold">React, Node.js e Python</span> e veja como conceitos ganham vida em soluções reais.
        </h2>
